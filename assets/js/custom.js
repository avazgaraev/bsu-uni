(function($) {
    ...
    langList.querySelectorAll("li").forEach(item => {
        ...
        langBtn.querySelector("span").textContent = selectedLang.toUpperCase();
  ...
  const slider = document.querySelector(".emekdasliq-slider");
  ...
  function moveSlider() {
    ...
    if (Math.abs(position) >= slideWidth * (slideItems.length / 2)) {
      position = 0;
    }
